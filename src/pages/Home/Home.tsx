...
export function Home({ userId }: HomeProps) {
  ...
  return (
    <Box className="Home">
      ...
      >
        <MuiLink
          href="https://github.com/jscott/chitchatter"
          target="_blank"
          sx={theme => ({
      ...
      <Typography variant="body1" sx={{ textAlign: 'center', mb: 1 }}>
        Licensed under{' '}
        <MuiLink
          href="https://github.com/jscott/chitchatter/blob/develop/LICENSE"
          target="_blank"
        >
          GPL v2
        </MuiLink>
        . Please{' '}
        <MuiLink
          href="https://github.com/jscott/chitchatter/blob/develop/README.md"
          target="_blank"
        >
          read the docs
        </MuiLink>
